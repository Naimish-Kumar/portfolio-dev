  ...
  const services = [
    {
      ...
      description: 'End-to-end full-stack web applications built on Next.js 14, Node.js, Express, and MySQL with sub-100ms API response times and scalable microservices.',
      icon: Code2,
      badge: 'NEXT.JS & NODE',
      spec: 'SPEC \ FULLSTACK',
    },
    ...
    {
      title: 'High-Performance Cloud & MySQL',
      description: 'Designing resilient relational database schemas, complex indexed queries, multi-tenant architectures, and zero-downtime Hostinger / Cloud deployments.',
      icon: Database,
      badge: 'MYSQL & CLOUD',
      spec: 'SPEC \ DATABASE',
    },
    {
      ...
      description: 'Native-feel iOS and Android applications with clean architecture, real-time Socket.IO synchronization, and automated CI/CD pipelines.',
      icon: Smartphone,
      badge: 'IOS & ANDROID',
      spec: 'SPEC \ MOBILE',
    },
    {
      title: 'Web Performance & CWV Tuning',
      description: 'Eliminating layout shifts (CLS), optimizing Largest Contentful Paint (LCP < 1.2s), and tree-shaking bundles for 99+ Google Lighthouse scores.',
      icon: Gauge,
      badge: 'PERF 99+ SCORE',
      spec: 'SPEC \ OPTIMIZATION',
    },
    {
      title: 'API Security & Auth Systems',
      description: 'Robust JWT token rotation, bcrypt password hashing, parameterized SQL queries, CORS policies, and rate-limiting security layers.',
      icon: ShieldCheck,
      badge: 'SECURITY & IAM',
      spec: 'SPEC \ SECURITY',
    },
